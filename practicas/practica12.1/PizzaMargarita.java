public class PizzaMargarita implements Pizza{
    ...
    public PizzaMargarita(){
        ingredientes = "Salsa de tomate, queso mozzarella, camaron";
        numDeRebanadas = 8;
    }
    public PizzaMargarita(String ingredientes, int numDeRebanadas){
    ...
    @Override 
    public void cocinar(){
        System.out.println("Cocinando la pizza margarita...");
    }
    @Override 
