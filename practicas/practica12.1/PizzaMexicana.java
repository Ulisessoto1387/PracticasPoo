public class PizzaMexicana implements Pizza{
    ...
    public PizzaMexicana(){
        ingredientes = "Salsa de tomate, queso mozzarella, hongos, jalapeños, carne molida";
        numDeRebanadas = 8;
    }
    public PizzaMexicana(String ingredientes, int numDeRebanadas){
    ...
    @Override 
    public void cocinar(){
        System.out.println("Cocinando la pizza mexicana...");
    }
    @Override 
