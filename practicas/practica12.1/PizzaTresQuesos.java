public class PizzaTresQuesos implements Pizza{

    String ingredientes;
    int numDeRebanadas;

    public PizzaTresQuesos(){
        ingredientes = "Salsa de tomate, queso mozzarella, queso manchego, queso oaxaca";
        numDeRebanadas = 8;
    }
    public PizzaTresQuesos(String ingredientes, int numDeRebanadas){
    ...
    @Override 
    public void cocinar(){
        System.out.println("Cocinando la pizza tres quesos...");
    }
    @Override 
